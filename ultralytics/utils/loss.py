...
class v8DetectionLoss:
    ...
    def __call__(self, preds, batch):
        ...
        self.kd_cache.update({
            'loss_box': loss[0].detach().clone(),
            'loss_cls': loss[1].detach().clone(),
            'loss_dfl': loss[2].detach().clone(),
            'loss_angle': torch.full_like(loss[0].detach(), float('nan')),
            'det_loss_items': loss.detach().clone(),
            'det_loss_total': loss.detach().sum(),
        })
