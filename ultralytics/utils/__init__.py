...
_NONE_STRING_KEYS = {'distill_gate_kd_mask_mode', 'distill_mid_kd_policy', 'distill_late_kd_policy'}
for k, v in DEFAULT_CFG_DICT.items():
    if k not in _NONE_STRING_KEYS and isinstance(v, str) and v.lower() == 'none':
